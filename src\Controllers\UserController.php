...
class UserController extends BaseController
{
     ...
     * Retrieve a User
     *
     * @param string $userId 0000-0000-0000-000000000000 (required,string) - Internal user ID (GUID)
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function retrieveAUser(
        $userId
    ) {
        ...
        return $mapper->mapClass($response->body, 'ZeroTierCentralAPILib\\Models\\User');
    }
    ...
    public function getAllViewableUsers()
    {
        ...
        return $mapper->mapClassArray($response->body, 'ZeroTierCentralAPILib\\Models\\User');
    }
}
